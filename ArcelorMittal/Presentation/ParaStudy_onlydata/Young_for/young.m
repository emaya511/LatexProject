...
E=["1E11","1.5E11","1.8E11","1.9E11","2E11","2.1E11","2.2E11","2.5E11","3E11"];

for i = 1 : numel(E)
    
    name=strcat(E(i),'\Dynamic');
    FEM=DYNAMIC(name);
    FEM.lg.lgit(sprintf('** Solving for E : %s',E(i)))
    ...
    FEM.U(2)=Dirichlet(FEM, [11], [1 0 0], 0 );
    %FEM.For(1)=Neumann(FEM, [20], [1 0 0], 1000 );
    ...
    FEM.ApplyF(FEM.For(1)*FEM.TS(1));
    FEM.ApplyF(FEM.For(2)*FEM.TS(1));
    FEM.ApplyF(FEM.For(3)*FEM.TS(1));
    FEM.ApplyF(FEM.For(4)*FEM.TS(1));
