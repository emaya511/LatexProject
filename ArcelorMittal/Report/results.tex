...
%***Strip with different line velocity is studied and the result are plotted here. the as the line velocity increased the wave reached faster to the measuring point. using this graph the wave spped is calucalted at it agress with the fulate. error is less than. ***
