...
\defbeamertemplate*{title page}{supdefault}[1][]
{
  ...
  \begingroup
    \centering
    \includegraphics[width=0.25\linewidth]{images/ArcelorMittal_logo.png}
    \vskip1em\par
...
\begin{figure}
\centering
\subfloat[Schematics of the Hot-Dip Galvanization Line \label{fig:galvline}]{\includestandalone[mode=image,build={quote={}},width=11.5cm]{"tikz/GalvLine_ppt"}} \quad
\end{figure}
\end{frame}
...
\centering
\subfloat[Hot-Dip Galvanization Line \label{fig:galvline}]{\includestandalone[mode=image,build={quote={}},width=7.5cm]{"tikz/GalvLine_Real"}} 
...
\begin{figure}
	\centering
	\subfloat[First subfigure \label{fig:a}][BuiltIN point load]
	{\includegraphics[trim={4cm 0 4cm 0},clip,width=3cm]{images/appedix_sim_result/C_BI_P.png}}
	\subfloat[First subfigure \label{fig:a}][BuiltIN distributed load]
...
\subfloat[First subfigure \label{fig:a}][Mesh : strip , Nn = 1886, Solution Time = 21s]{\includestandalone[mode=image,build={quote={}},width=0.8\textwidth]{"pgfplots/FEMvsGAL_ppt"}}
...
\begin{figure}
\subfloat[First subfigure \label{fig:a}][Mesh : strip , Nn = 1886, Solution Time = 21s]{\includestandalone[mode=image,build={quote={}},width=0.8\textwidth]{"pgfplots/Strip_Para_V"}}
\end{figure}
